...
### File names
The source files in this repo are named SPI.cpp and SPI.h.  These are the same as the names of those in standard SPI library in the Arduino distribution. The intent was to fix and upgrade the official library.  On my machine, the arduino supplied library is at  ~/.arduino15/packages/arduino/hardware/renesas_uno/1.2.0/libraries/SPI and put these in their place.   The version number 1.2.0 may be different on your machine
